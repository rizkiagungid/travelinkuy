...
<html lang="en">
  <head>
    ...
    <!-- Homepage -->
    <title>Pantai Pink - TravelinKuy</title>

    <!-- DATA POSTINGAN -->
    <?php

    $title = "Travelin'sKuy";
    $pembuatpost = "Travelin'sKuy";
    $judul = "Pantai Pink";

    $deskripsi_singkat = "Pantai Pink Labuan Bajo berada di Pulau Komodo, Flores Barat, Nusa Tenggara Timur. Untuk menuju ke Lokasi, para wisatawan memang harus memanfaatkan beberapa moda transportasi. Karena keberadaannya di pulau yang dikelilingi oleh pantai-pantai.";

    $deskripsi = "Cara yang paling mudah untuk menuju Labuan Bajo adalah melalui Bali. Menggunakan pesawat berkapasitas 50 penumpang, para wisatawan bisa langsung mendarat di Bandar Udara Labuan Bajo. Dari Bandar Udara Labuan Bajo dilanjutkan menuju Pulau Komodo. Dengan memanfaatkan jasa sewa kapal Labuan Bajo, yaitu speed boat, para wisatawan diantarkan menuju Dermaga Loh Liang, Pulau Komodo. Perjalanan menggunakan speed boat memakan waktu lebih sedikit dibandingkan dengan tracking";

    $deskripsi2 = "Tracking menuju spot wisata ini lumayan menantang. Namun para wisatawan bisa sambil menikmati pemandangan sekitar dan melihat Komodo dari dekat. Perjalanan tracking memakan waktu sekitar 4 jam dengan melewati tebing-tebing karang dan hutan bakau. Warna merah muda tersebut ternyata berasal dari hewan berukuran mikroskopik bernama Foraminifera yang memberikan warna merah pada koral. Koral-koral tersebut terbawa ombak menuju pesisir, lalu menjadi serpihan yang menyatu dengan pasir";
  ...
  <body>
    ...
    <img src="../pantai-pink/pantai-pink.jpg"style="width: 100%;height:650px;"class="img-fluid bali" alt="...">
    </div>
    <div class="carousel-caption d-none d-md-block">
          <h1 class="animate__animated animate__bounceIn delay-150 title-slider">Selamat Datang di NTT</h1>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <!-- START FOTO -->
      <img src="../pantai-pink/pantai-pink-2.jpg" style="width:600px;height:350px;" class="img-thumbnail" alt="...">
      <!-- END FOTO -->
        ...
        <img src="../pantai-pink/pantai-pink-3.jpg"style="width:600px;height:350px; alt="..."><br><br>
        ...
        <div class="row">
        <iframe class="col-lg-12 col-md-12 col-sm-12" width="560" height="315" src="https://www.youtube.com/embed/K7WhvIlu1U4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
        <br>
        <!-- END VIDEO YOUTBE-->
      <article class="blog-post">
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-light rounded">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15781.433998018048!2d119.15845541500003!3d-8.561483832839919!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2db5a4439b836943%3A0xc2c05d7ff0dee0f2!2sPantai%20Pink%20Lambu%2C%20Bima%20NTB!5e0!3m2!1sid!2sid!4v1639319077662!5m2!1sid!2sid" width="400px" height="350px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>

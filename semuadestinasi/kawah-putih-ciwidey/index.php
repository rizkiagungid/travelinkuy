...
<html lang="en">
  <head>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <!-- Homepage -->
    <title>Ciwidey - TravelinKuy</title>
    ...
    $judul = "Kawah Putih Ciwidey";

    $deskripsi_singkat = "Kawah Putih adalah tempat wisata di Bandung yang paling terkenal. di Ciwidey, Jawa Barat, kurang lebih sekitar 50 KM arah selatan kota Bandung, Kawah Putih Bandung adalah sebuah danau yang terbentuk akibat dari letusan Gunung Patuha.";

    $deskripsi = "Kawah Putih adalah tempat wisata di Bandung yang paling terkenal. di Ciwidey, Jawa Barat, kurang lebih sekitar 50 KM arah selatan kota Bandung, Kawah Putih Bandung adalah sebuah danau yang terbentuk akibat dari letusan Gunung Patuha. Sesuai dengan namanya, tanah yang ada di kawasan ini berwarna putih akibat dari pencampuran unsur belerang. Selain tanahnya yang berwarna putih, air danau kawasan Kawah Putih Bandung juga mempunyai warna yang putih kehijauan dan dapat berubah warna sesuai dengan kadar belerang yang terkandung, suhu, dan cuaca";

    $deskripsi2 = "Kawah Putih Bandung berada di kawasan pegunungan yang mempunyai ketinggian lebih dari 2.400 meter di atas permukaan laut. Dengan ketinggian tersebut, suhu udara di tempat wisata ini tentu saja dingin dengan suhu 8 derajat Celsius sampai dengan 22 derajat Celsius, oleh karena itu jangan lupa membawa jaket atau memakai pakaian yang tebal. Selain untuk dinikmati keindahannya oleh para wisatawan, Kawah Putih Bandung juga sering kali menjadi tempat kegiatan lain, misalnya pengambilan gambar film, melukis, foto pengantin, sampai dengan kegiatan mendaki dan berkuda";
  ...
  <body>
    ...
    <img src="../kawah-putih-ciwidey/kawah-putih.jpg"style="width: 100%;height:650px;"class="img-fluid bali" alt="...">
    </div>
    <div class="carousel-caption d-none d-md-block">
          <h1 class="animate__animated animate__bounceIn delay-150 title-slider">Selamat Datang di Bandung</h1>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <!-- START FOTO -->
      <img src="../kawah-putih-ciwidey/kawah-putih-2.jpg" style="width:600px;height:350px;" class="img-thumbnail" alt="...">
      <!-- END FOTO -->
        ...
        <img src="../kawah-putih-ciwidey/kawah-putih-3.jpg"style="width:600px;height:350px; alt="..."><br><br>
        ...
        <div class="row">
        <iframe class="col-lg-12 col-md-12 col-sm-12" width="560" height="315" src="https://www.youtube.com/embed/H2pU69Y6SsM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
        <br>
        <!-- END VIDEO YOUTBE-->
      <article class="blog-post">
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-light rounded">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.859033017705!2d107.395669114005!3d-7.142294872041888!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e688b9aaaaaaaab%3A0xbea2f7158300fabc!2sKawah%20Putih%20Parkir%20Bus!5e0!3m2!1sid!2sid!4v1639201924610!5m2!1sid!2sid" width="400px" height="350px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>

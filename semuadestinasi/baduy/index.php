...
<html lang="en">
  <head>
    ...
    $deskripsi_singkat = "Destinasi wisata budaya adat memang selalu menarik perhatian setiap pecinta wisata. Keunikan budaya dan gaya hidup masyarakatnya yang masih tradisional menjadi daya tarik tersendiri bagi wisatawan";
    $deskripsi = "Suku Baduy  Destinasi wisata budaya adat memang selalu menarik perhatian setiap pecinta wisata. Keunikan budaya dan gaya hidup masyarakatnya yang masih tradisional menjadi daya tarik tersendiri bagi wisatawan. Objek wisata tersebut salah satunya adalah wisata di Pandeglang Banten yang satu ini. Wisata Baduy di Pandeglang Banten mungkin dapat menjadi salah satu pilihan bagi anda dalam menentukan destinasi wisata
  <br>
     Sejarah kampung baduy bahasa sunda juga sangatlah unik dan menjadi daya tarik tersendiri yang akan menambah pengetahuan anda tentang keberagaman Indonesia. Anda juga dapat belajar tentang suku baduy di sekolah alam Kandank jurank doang
  <br>
    Indonesia memang penuh keunikan dengan kearifan lokal suku-suku yang masih terjaga hingga saat ini, sehingga menarik untuk ditelusuri. Keberagaman suku dan budaya membuat Indonesia sangat kaya dengan nilai-nilai budaya yang unik. Salah satunya adalah suku baduy. Adat istiadat suku baduy masih dipertahankan, begitu pula alam sekitar kampung baduy juga masih sangat terjaga.";
    $deskripsi2 = "Wisata Baduy di Pandeglang Banten mungkin dapat menjadi salah satu pilihan bagi anda dalam menentukan destinasi wisata mempunyai keunikan dan pesonanya tersendiri, lho!";
   ...
   <body>
    ...
    <img src="2_011119024736.jpg"style="width: 100%;height:650px;"class="img-fluid bali" alt="...">
    </div>
    <div class="carousel-caption d-none d-md-block">
          <h1 class="animate__animated animate__bounceIn delay-150 title-slider">Selamat Datang di Banten</h1>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <!-- START FOTO -->
      <img src="2_011119024736.jpg" style="width:600px;height:350px;"  class="img-thumbnail" alt="...">
      <!-- END FOTO -->
        ...
        <div class="row">
        <iframe class="col-lg-12 col-md-12 col-sm-12" width="560" height="315" src="https://www.youtube.com/embed/hBuifj0X4Xw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
        <br>
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-light rounded">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3963.313779980553!2d106.22026071399931!3d-6.607876566431096!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e42691f0ca8c471%3A0xc7dce717ca9ffcd1!2sWisata%20Kampung%20Marengo%20Baduy%20Luar!5e0!3m2!1sid!2sid!4v1639319624722!5m2!1sid!2sid" width="400px" height="350px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>

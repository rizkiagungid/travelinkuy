...
<html lang="en">
  <head>
    ...
    <!-- Homepage -->
    <title>Danau Kelimutu - TravelinKuy</title>
    ...
    $deskripsi_singkat = "Danau Kelimutu atau Tiwu Kelimutu berada di Woloara, Kelimutu, Kabupaten Ende. Nama Kelimutu sendiri diambil dari kata “Keli” yang berarti gunung dan “Mutu” yang artinya mendidih. ";

    $deskripsi = "Terdapat tiga danau yang ada di kawasan ini. Ketiganya memiliki warna berbeda dan dapat berubah setiap saat. Itulah mengapa Danau Kelimutu juga dikenal sebagai Danau Tiga Warna. Menurut beberapa pakar, air danau dapat berubah warna akibat komposisi material yang terdapat di dasar danau";

    $deskripsi2 = "Ketiga danau di kawasan ini bernama Tiwu Ata Polo (danau warna merah), Tiwu Nua Muri Koo Fai (danau warna biru) dan Tiwu Ata Mbupu (danau warna putih). Tiga danau ini diperkirakan memiliki luas sekitar 1.051.000 meter persegi. Uniknya masyarakat setempat memiliki kepercayaan bahwa setiap warna memiliki makna tertentu";
  ...
  <body>
    ...
    <img src="../danau-kelimutu/kelimutu.jpg"style="width: 100%;height:650px;"class="img-fluid bali" alt="...">
    </div>
    <div class="carousel-caption d-none d-md-block">
          <h1 class="animate__animated animate__bounceIn delay-150 title-slider">Selamat Datang di Nusa Tenggara Timur</h1>
  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        <!-- START FOTO -->
      <img src="../danau-kelimutu/kelimutu-2.jpg" style="width:600px;height:350px;" class="img-thumbnail" alt="...">
      <!-- END FOTO -->
        ...
        <img src="../danau-kelimutu/kelimutu-3.jpg"style="width:600px;height:350px; alt="..."><br><br>
        ...
        <div class="row">
        <iframe class="col-lg-12 col-md-12 col-sm-12" width="560" height="315" src="https://www.youtube.com/embed/SjVxa6PNYAw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
        <br>
        <!-- END VIDEO YOUTBE-->
      <article class="blog-post">
    ...
    <div class="col-md-4">
      <div class="position-sticky" style="top: 2rem;">
        <div class="p-4 mb-3 bg-light rounded">
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15772.849062329171!2d121.80541191504177!3d-8.766089642102628!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dad42cbad3700fd%3A0xd134f42033d607ed!2sDanau%20Kelimutu!5e0!3m2!1sid!2sid!4v1639202440181!5m2!1sid!2sid" width="400px" height="350px" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </div>
